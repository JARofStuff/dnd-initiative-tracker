...
const MobileNavBar: FC<{ menuLinks: MenuLink[] }> = ({ menuLinks }) => {
  ...
  return (
    <nav
      ...
      className='md:hidden fixed z-100 bottom-0 right-0 left-0 h-14 flex justify-around border-t bg-white dark:bg-slate-900 border-indigo-100 dark:border-indigo-900 '
    >
